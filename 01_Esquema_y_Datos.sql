...
-- tablas hechas para la auditoria y el soporte
...
-- La fk de ventas hacia las sucursales se agrega después de crear las tablas
ALTER TABLE ventas
...
-- tabla de auditoria de inicios de sesión fallidos 
...
-- indices hechos para la optimizacion de las consultas
