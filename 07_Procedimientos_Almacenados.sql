...
-- 3. sp_ActualizarDireccionCliente: actualiza la dirección de un cliente (para poder espiarlo por las noches y su dia).
...
-- 4. sp_ProcesarDevolucion: gestiona la devolución de un producto y ajusta el stock (nos duele hacerlo).
...
-- 7. sp_EliminarClienteDeFormaSegura: anonimiza los datos del cliente (no los borra, pero nosotros tenemos el control de estos).
...
-- 11. sp_RegistrarNuevoCliente: registra un cliente validando email y contraseña (pa que solo sea uno mas de nuestra granja).
...
-- 13. sp_FusionarCuentasCliente: fusiona dos cuentas de cliente duplicadas en una (ni con multicuenas te salvas).
...
-- 15. sp_BuscarProductos: busqueda avanzada con filtros opcionales.
...
-- 16. sp_ObtenerDashboardAdmin: KPIs para un panel de administracion.
...
-- Prueba de los procedimientos hechos
...
-- Listado de los procedimientos hehos
